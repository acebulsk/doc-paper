...
npctr_bsns <- read_sf("data/gis/npctr_basins/npctr_basins.shp") %>% 
...
st_filter2 <- st_sf(st.filter)

saveRDS(st_filter2, "data/gis/wsc_gauge_basins/wsc_unreg_basin_points_w_data_available.rds")

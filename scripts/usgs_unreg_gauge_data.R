...
dams <- read.csv(file = "../data/unregulated_gauge_flows/usgs_metadata/conterm_hydromod_dams.txt") %>% 
...
usgs_shp1 <- st_read("../data/unregulated_gauge_flows/usgs_metadata/boundaries-shapefiles-by-aggeco/bas_nonref_AKHIPR.shp") 
usgs_shp2 <- st_read("../data/unregulated_gauge_flows/usgs_metadata/boundaries-shapefiles-by-aggeco/bas_nonref_CntlPlains.shp")
usgs_shp3 <- st_read("../data/unregulated_gauge_flows/usgs_metadata/boundaries-shapefiles-by-aggeco/bas_nonref_MxWdShld.shp")
usgs_shp4 <- st_read("../data/unregulated_gauge_flows/usgs_metadata/boundaries-shapefiles-by-aggeco/bas_nonref_WestMnts.shp")
usgs_shp5 <- st_read("../data/unregulated_gauge_flows/usgs_metadata/boundaries-shapefiles-by-aggeco/bas_nonref_WestPlains.shp")
usgs_shp6 <- st_read("../data/unregulated_gauge_flows/usgs_metadata/boundaries-shapefiles-by-aggeco/bas_nonref_WestXeric.shp")
...
usgs_shp <- st_read("../data/unregulated_gauge_flows/usgs_metadata/boundaries-shapefiles-by-aggeco/bas_ref_all.shp") %>%
...
# st_write(usgs_shp, "../data/unregulated_gauge_flows/usgs_unregulated_basins_1991-2020.shp")

# wsc_shp <- st_read("../data/unregulated_gauge_flows/wsc_unregulated_1991_2020_flows.shp") %>% st_make_valid()
# 
# tm_shape(usgs_shp) +
...
saveRDS(q_final, "usgs_1991_2020_raw_monthly_flows.rds")
...
write.csv(flowdepth, "../data/unregulated_gauge_flows/usgs_unregulated_1991-2020_long.csv")
...
st_write(usgs_shp %>% filter(GAGE_ID %in% flowdepth$site_no), "../data/unregulated_gauge_flows/usgs_unregulated_basins_1991-2020.shp")
